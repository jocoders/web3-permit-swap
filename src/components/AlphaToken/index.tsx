import alphaLogo from '../../../public/alpha.webp'
import { TOKEN_ALPHA_ADDRESS } from '../../const/contract'
import { Header, Image, Row, Spacer, Text } from '../Basic'
import { DoubleInputBlock } from '../DoubleInputBlock'
import { InputBlock } from '../InputBlock'

import { useAlphaTokenController as useController } from './controller'
...
export const AlphaToken = () => {
  ...
  return (
    <Container>
      <Row>
        <Image source={alphaLogo} alt="Alpha Logo" />
        <Header text="Alpha Token" />
      </Row>
      <Spacer height={10} />
      ...
      <Spacer height={4} />
      <Text>{`Contract address: ${TOKEN_ALPHA_ADDRESS}`}</Text>
      <Spacer height={4} />
